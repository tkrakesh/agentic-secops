...
| **5**   | **AI Threat Synthesis** | **< 30 sec** | **ThreatAnalystAgent** identifies the human risk instantly with high confidence. |
| **6**   | **Unified HITL** | **< 60 sec** | Analyst approves in **one single UI** with full context provided. |
| **7-8** | **Automated Execution** | **< 30 sec** | **ActionExecutorAgent** isolates hosts and updates ServiceNow instantly. |
